      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="relative my-20 overflow-hidden rounded-3xl border border-white/20 bg-gradient-to-br from-slate-900 to-slate-800 p-8 sm:p-12 text-white">
          <div className="absolute inset-0">
            <div className="pointer-events-none absolute -left-16 -top-16 h-64 w-64 rounded-full bg-gradient-to-br from-blue-600/40 to-cyan-400/40 blur-3xl" />
          ...
          <div className="relative grid grid-cols-1 gap-8 sm:grid-cols-3">
            <div className="sm:col-span-2">
              <h3 className="text-2xl font-semibold sm:text-3xl">Make payments that feel effortless</h3>
              <p className="mt-2 max-w-xl text-slate-300">Tell us about your project and we’ll design a solution that’s secure, elegant, and built to scale.</p>
            </div>
            <div className="flex items-end">
              ...
              >
                ...
                <span className="grid h-9 w-9 place-items-center rounded-xl bg-gradient-to-r from-blue-600 to-cyan-500 text-white">
